...
int main(int argc, char* argv[]){
    ...
    for(unsigned int currentGalaxy = 0; currentGalaxy < nbGalaxies; ++currentGalaxy){
        ...
        galaxies[currentGalaxy].line += (lineExpansion * 999999);
        ...
        galaxies[currentGalaxy].row += (rowExpansion * 999999);
    }
    ...
    //Prints the number
    printf("\033[1;37mHere is the sum of the lengths of the shortest paths between every pair of galaxies : \033[1;34m%lld\033[0m\n", sum);
}